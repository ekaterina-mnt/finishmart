...
$script_iteration_condition = "provider='mosplitka'";
//
...
try {
    ...
    $links = MySQL::sql("SELECT link, provider from all_products WHERE provider='" . $script_iteration_provider . "' and " . $script_iteration_condition . " ORDER BY date_edit LIMIT 10");
