...
<КоммерческаяИнформация ПараметрПакета="1" ВерсияСхемы="2.021" ДатаФормирования="2023-10-20T23:56:59">
    ...
    static function mode_query_package_goods($goods)
    {
        $xmlString = '<?xml version="1.0" encoding="UTF-8"?>
<КоммерческаяИнформация ВерсияСхемы="2.021" ПараметрПакета="2" ДатаФормирования="2023-10-20T23:57:16">
	<Каталог>
        ...
        static function mode_query_package_offers($goods)
    {
        $xmlString = '<?xml version="1.0" encoding="UTF-8"?>
<КоммерческаяИнформация ПараметрПакета="3" ВерсияСхемы="2.021" ДатаФормирования="2023-10-20T23:57:29">
	<ПакетПредложений>
		<Ид>catalog-masterdom</Ид>
		<ИдКлассификатора>1c-classificator-masterdom</ИдКлассификатора>
		<Наименование>Мастердом</Наименование>
        ...
        echo $xmlString;
            ...
            static function mode_query_package_end()
    {
        echo "finished=yes";
    }
}
