    ...
    if (isset($_GET['mode'])) {
        ...
        if ($_GET['mode'] == 'query' and isset($_GET['package'])) {
            ...
            //Товары
                ...
                writeCustomLog("Началась передача товаров начиная с id=$start", $provider);
            ...
            //Товарные предложения
                ...
                Logs::writeCustomLog("Началась передача товарных предложений начиная с id=$start", $provider);
                exit;
            }
        }
    }
